...
#toTop {
	...
	window.onload = function() {
		...
		function loadImg() {
			...
			$.ajax({
				url : '__ROOT__/?m=index&a=index_ajax&sort=hot&p=' + pageNum
						+ "&cate_id=" + cate_id,
				type : "POST",
				dataType : "json",
